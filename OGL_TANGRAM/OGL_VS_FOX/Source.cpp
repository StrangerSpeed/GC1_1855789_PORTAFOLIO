...
int main()
{
    ...
    float verticesTriangulosColores[] = {
        //Posicion          Color
         0.0f,-0.2f, 0.0f, 1.0, 0.0, 0.0,  // 0
        -0.2f, 0.0f, 0.0f, 1.0, 0.0, 0.0,  // 1
         0.2f, 0.0f, 0.0f, 1.0, 0.0, 0.0,  // 2 

         0.0f, 0.2f, 0.0f, 1.0, 0.0, 0.0,  // 3
        -0.2f, 0.0f, 0.0f, 1.0, 0.0, 0.0,  // 4
         0.2f, 0.0f, 0.0f, 1.0, 0.0, 0.0,  // 5

         0.0f, -0.2f, 0.0f, 1.0, 0.5, 0.0,  // 6
         1.0f, -0.2f, 0.0f, 1.0, 0.5, 0.0,  // 7
         0.5f,  0.3f, 0.0f, 1.0, 0.5, 0.0,  // 8

         0.0f, -0.2f, 0.0f, 1.0, 0.0, 1.0,  //9
        -1.0f, -0.2f, 0.0f, 1.0, 0.0, 1.0,  //10
        -0.5f,  0.3f, 0.0f, 1.0, 0.0, 1.0,  //11

        -0.2f, -0.6f, 0.0f, 0.0, 0.0, 1.0,  //12
         0.3f, -0.6f, 0.0f, 0.0, 0.0, 1.0,  //13
        -0.6f, -0.2f, 0.0f, 0.0, 0.0, 1.0,  //14

         0.0f, -0.2f, 0.0f, 0.0, 0.0, 1.0,  //15
         0.3f, -0.6f, 0.0f, 0.0, 0.0, 1.0,  //16
        -0.6f, -0.2f, 0.0f, 0.0, 0.0, 1.0,  //17

         0.0f, -0.2f, 0.0f, 0.5, 1.0, 1.0,  //18
         0.3f, -0.6f, 0.0f, 0.5, 1.0, 1.0,  //19
         0.6f, -0.2f, 0.0f, 0.5, 1.0, 1.0,  //20

        -0.2f,  0.0f, 0.0f, 1.0, 1.0, 0.0,  //21
         0.0f,  0.2f, 0.0f, 1.0, 1.0, 0.0,  //22
        -0.2f,  0.4f, 0.0f, 1.0, 1.0, 0.0,  //23

         0.2f,  0.0f, 0.0f, 0.0, 1.0, 0.0,  //24
         0.0f,  0.2f, 0.0f, 0.0, 1.0, 0.0,  //25
         0.2f,  0.4f, 0.0f, 0.0, 1.0, 0.0,  //26
    };
